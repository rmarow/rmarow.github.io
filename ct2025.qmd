...
- **which motor to use** -- servo or stepper? We ultimately went with servo due to finding more information online relevant to this idea.  
- **laser cut wood or 3D print the maze** -- aesthetically we liked the look of the maze being carved out of wood but with marble (or bead) sizes and the strength of the motors it seemed more logical to go with 3D printing.  
- **power** - to be continued....  


Phase 1: Getting the motors to work together and be controlled by a joystick.  

![](attachments/mb-joystick.MOV){width=300}

Testing the system with cardboard.  
